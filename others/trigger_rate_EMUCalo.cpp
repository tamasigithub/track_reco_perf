...
void plot_rate()
{
	//f1 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/TrigSEMU5GeV_PU1kMB_q1.2GeVeta2.5_30mmR0.4_1.root");
	//f2 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/TrigSEMU5GeV_PU1kMB_q1.2GeVeta2.5_30mmR0.3_1.root");
	//f3 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/TrigSEMU5GeV_PU1kMB_q1.2GeVeta2.5_30mmR0.2_1.root");
	f1 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/CELL_a50c3_ALL_PU1kMB_ETA2.5_30mm_R0.4_3.root");
	//f1 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/CELL1_a50c3_ALL_PU1kMB_ETA2.5_30mm_R0.4_2.root");
	f2 = new TFile("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/CELL1_a50c3_ALL_PU1kMB_ETA2.5_30mm_R0.3_2.root");
	...
	leg->SetFillStyle(0);
	leg->SetBorderSize(0);
	leg->AddEntry(h2_1,"#Delta R = 0.4","l");
	leg->AddEntry(h2_2,"#Delta R = 0.3","l");
	...
	c->SetLogy();
	c->SaveAs("/media/tamasi/Z/PhD/FCC/Castellated/TriggerStudies/CELL1_calo_trigRate_2.tex");
