...
//int Njeteff_trkjets(const char* output_file_name = "NjeteffITK4trk_501.5", bool debug = false)
int Njeteff_trkjets(const char* output_file_name = "Njeteffttt4trk_501.5", bool debug = false)
{
	...
	/*tree.SetBranchStatus("std4trkjetPt",1);
	tree.SetBranchStatus("std4trkjetEta",1);
	tree.SetBranchStatus("std4trkjetPhi",1);*/
	...
	/*tree.SetBranchAddress("std4trkjetPt", &Pt_TTTtrkjet );
	tree.SetBranchAddress("std4trkjetEta",&Eta_TTTtrkjet);
	tree.SetBranchAddress("std4trkjetPhi",&Phi_TTTtrkjet);*/
	...
	h_trigeffN4_v1->Draw("same");
        //TLegend *leg1=new TLegend(x1,y1,x2,y2,"Atleast N triplet std jets");
	...
	leg1->SetBorderSize(0);
        ...
        /*leg1->AddEntry(h_trigeffN1_v1,"1 std track jet ","p");
        leg1->AddEntry(h_trigeffN2_v1,"2 std track jets","p");
        leg1->AddEntry(h_trigeffN3_v1,"3 std track jets","p");
        leg1->AddEntry(h_trigeffN4_v1,"4 std track jets","p");*/
	...
	h_trigeffN4_v2->Draw("same");
        //TLegend *leg2=new TLegend(x1,y1,x2,y2,"Atleast N std track jets");
	...
	leg2->SetTextSize(0.035);
        ...
        /*leg2->AddEntry(h_trigeffN1_v2,"1 std track jet ","p");
        leg2->AddEntry(h_trigeffN2_v2,"2 std track jets","p");
        leg2->AddEntry(h_trigeffN3_v2,"3 std track jets","p");
        leg2->AddEntry(h_trigeffN4_v2,"4 std track jets","p");*/
        leg2->Draw();
	leg1a->Draw();
	c2->Update();
