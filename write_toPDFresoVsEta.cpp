...
int write_topdf(const char* output_file_name = "ResoVsEta_InDetTTT_hh4b1.4_5GeV")
{
	...
	//!InDet tracks
	TFile* f = TFile::Open("./plots/reso_plots/ResoVsEtaInDet_all1.4_5GeV.root");
...
//	TH1D* h_dca	= (TH1D*)f->Get("h_sigma_dca");
	...
	//! TTT tracks
	TFile* f0 = TFile::Open("./plots/reso_plots/ResoVsEtaTTT_all1.4_5GeV.root");
