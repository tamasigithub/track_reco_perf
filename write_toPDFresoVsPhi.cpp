...
int write_topdf(const char* output_file_name = "ResoVsPhi_InDetTTT_hh4b1.4_5GeV")
{
	...
	//!InDet tracks
	TFile* f = TFile::Open("./plots/reso_plots/ResoVsphiInDet_all1.4_5GeV.root");
...
//	TH1D* h_dca	= (TH1D*)f->Get("h_sigma_dca");
	...
	//! TTT tracks
	TFile* f0 = TFile::Open("./plots/reso_plots/ResoVsphiTTT_all1.4_5GeV.root");
...
//        h0_dca->GetXaxis()->SetTitleSize(.05);
	...
	h_phi->GetXaxis()->SetTitle("#phi_{gen}");
	h_theta->GetXaxis()->SetTitle("#phi_{gen}");
	h_eta->GetXaxis()->SetTitle("#phi_{gen}");
	h_z0->GetXaxis()->SetTitle("#phi_{gen}");
//	h_dca->GetXaxis()->SetTitle("#phi_{gen}");

	h0_dp->GetXaxis()->SetTitle("#phi_{gen}");
        h0_invpt->GetXaxis()->SetTitle("#phi_{gen}");
        h0_phi->GetXaxis()->SetTitle("#phi_{gen}");
        h0_theta->GetXaxis()->SetTitle("#phi_{gen}");
        h0_eta->GetXaxis()->SetTitle("#phi_{gen}");
        h0_z0->GetXaxis()->SetTitle("#phi_{gen}");
//        h0_dca->GetXaxis()->SetTitle("#phi_{gen}");
