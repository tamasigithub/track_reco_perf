...
int write_topdf(const char* output_file_name = "ResoVsPhi_InDetTTT_hh4b")
{
	...
	//!InDet tracks
	TFile* f = TFile::Open("./plots/reso_plots/ResoVsphiInDet_all.root");
...
//	TH1D* h_dca	= (TH1D*)f->Get("h_sigma_dca");
	...
	//! TTT tracks
	TFile* f0 = TFile::Open("./plots/reso_plots/ResoVsphiTTT_all.root");
