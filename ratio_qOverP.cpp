...
int ratio_qOverP(const char* output_file_name = "ratio_qOverP", bool debug = false)
{
	...
	TH1F* h1 = new TH1F("h1","reconstructed qOverP; qOverP[MeV/c^{-1}];",nbins, xmin, xmax);//ttt 
	TH1F* h2 = new TH1F("h2","reconstructed qOverP; qOverP[MeV/c^{-1}];",nbins, xmin, xmax);

	tree.Draw("TTTqOverP>>h1");
	tree.Draw("InDetqOverP>>h2",InDet_cut);
