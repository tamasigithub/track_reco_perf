...
int newTTTpurity_Vs_etaphipt(const char* output_file_name = "prev_purwide_PU0hh4b_m26020mm", bool save = false)
{
//! Define Cut
...
*/TCut num_select= "M_barcode > 0  && abs(Pt_n)>2000 && abs(Eta13)<1.6  && abs(Z013) < 100";
TCut den_select= "M_barcode >= 0 && abs(Pt_n)>2000 && abs(Eta13)<1.6 && abs(Z013) < 100";

	TChain recTree("m_recTree");
	//! wide
        recTree.Add("/home/tamasi/repo_tamasi/rec_files/PU0hh4b_m260_recTree_200001_wide.root");
	//! nokap
        //recTree.Add("/home/tamasi/repo_tamasi/rec_files/PU0hh4b_m260_recTree_200001_loose.root");
	//! sig5
        //recTree.Add("/home/tamasi/repo_tamasi/rec_files/PU0hh4b_m260_recTree_200001_opt.root");
	//! sig3
        //recTree.Add("/home/tamasi/repo_tamasi/rec_files/PU0hh4b_m260_recTree_200001_sig3.root");
