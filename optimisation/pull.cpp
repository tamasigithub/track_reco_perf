...
int pull(const char* output_file_name = "pullPU200hh4b_30mm", const char* constants ="B")
{
...
int write_to_pdf(const char* input_file_name = "pullPU200hh4b_30mm.root", const char* output_file_name = "pullPU200hh4b_30mm")
{
