...
int write_to_pdf(const char* input_file_name = "control_30mm_ggF_BR.root", const char* output_file_name = "control_30mm_ggF_BR")
...
*/
	TF1 * dz2 = (TF1*)f->Get("fdz2");
	TF1 * dz2_ = (TF1*)f->Get("fdz2_");
	TH2F* H1  = (TH2F*)f->Get("h1"); 
        ...
        */            
        ...
        TH2F* tH27 = (TH2F*)f->Get("th27");
        TH2F* tH28 = (TH2F*)f->Get("th28");
        TH2F* tH28a= (TH2F*)f->Get("th28a");
        TH2F* tH29 = (TH2F*)f->Get("th29");
	...
	TH1F* H_pur_vs_eta_     = (TH1F*)f->Get("h_pur_vs_eta_");
	...
	TH1F* H_pur_vs_pt_      = (TH1F*)f->Get("h_pur_vs_pt_");
	...
	l2->AddEntry(H2,"truth, Phi_{13}<0.02");
	l2->Draw();
	...
	l9->AddEntry(H11,"truth, phibarel, z0");
	l9->Draw();
	S->Print(out_file_, "pdf");
        S->Clear();
	S->Divide(2,2);
	...
	/*dz2_l->Draw("same");
        dz2_m->Draw("same");
        dz2_t->Draw("same");*/
	TLegend *l26=new TLegend(x1,yy1,x2,y2,"fakes");
	l26->SetBorderSize(0);
        l26->SetTextAlign(32);
        l26->SetTextSize(0.035);
	l26->AddEntry(H27,"#splitline{phibarrel, mintpt,}{ maxeta, zbarrel, z0}");
	l26->Draw();
	//S->Print(out_file_, "pdf");
	S->cd(2);
        H28a->Draw();
	...
	l27->AddEntry(H28a,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0, no e's}");
	l27->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(3);
	H28->Draw();
	...
	l28->AddEntry(H28,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	l28->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(4);
	H29->Draw();
	...
	dz2_m->Draw("same");
	dz2_t->Draw("same");*/
	TLegend *l29=new TLegend(x1,yy1,x2,y2,"truth");
	l29->SetBorderSize(0);
        l29->SetTextAlign(32);
	...
	S->Divide(2,2);
        S->cd(1);
	tH24->Draw();
	TLegend *tl22=new TLegend(x1,yy1,x2,y2,"fakes");
	...
	//S->Print(out_file_, "pdf");
        S->cd(3);
	tH25->Draw();
	TLegend *tl24=new TLegend(x1,yy1,x2,y2,"matched_rec");
	...
	//S->Print(out_file_, "pdf");
        S->cd(4);
	tH26->Draw();
	TLegend *tl25=new TLegend(x1,yy1,x2,y2,"truth");
	...
	tl26->AddEntry(tH27,"#splitline{phibarrel, mintpt,}{ maxeta, zbarrel, z0}");
	tl26->Draw();
	//S->Print(out_file_, "pdf");
	S->cd(2);
        tH28a->Draw();
	TLegend *tl27=new TLegend(x1,yy1,x2,y2,"matched_rec");
	tl27->SetBorderSize(0);
        tl27->SetTextAlign(32);
        tl27->SetTextSize(0.035);
	tl27->AddEntry(tH28a,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0, no e's}");
	tl27->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(3);
	tH28->Draw();
	TLegend *tl28=new TLegend(x1,yy1,x2,y2,"matched_rec");
	tl28->SetBorderSize(0);
        tl28->SetTextAlign(32);
        tl28->SetTextSize(0.035);
	tl28->AddEntry(tH28,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	tl28->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(4);
	tH29->Draw();
	TLegend *tl29=new TLegend(x1,yy1,x2,y2,"truth");
	tl29->SetBorderSize(0);
        tl29->SetTextAlign(32);
        tl29->SetTextSize(0.035);
	tl29->AddEntry(tH29,"#splitline{minpt, maxeta,}{ z0}");
	tl29->Draw();
	S->Print(out_file_, "pdf");
        S->cd(1);
	H30->Draw();
	TLegend *l30=new TLegend(x1,yy1,x2,y2,"fakes");
	l30->SetBorderSize(0);
        l30->SetTextAlign(32);
        l30->SetTextSize(0.035);
	l30->AddEntry(H30,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	l30->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(2);
	H31->Draw();
	...
	l31->AddEntry(H31,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	l31->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(3);
	H32->Draw();
	TLegend *l32=new TLegend(x1,yy1,x2,y2,"truth");
	l32->SetBorderSize(0);
        l32->SetTextAlign(32);
        l32->SetTextSize(0.035);
	l32->AddEntry(H32,"#splitline{minpt, maxeta,}{ z0}");
	l32->Draw();
	S->Print(out_file_, "pdf");
        S->cd(1);
	H33->Draw();
	TLegend *l33=new TLegend(x1,yy1,x2,y2,"fakes");
	l33->SetBorderSize(0);
        l33->SetTextAlign(32);
        l33->SetTextSize(0.035);
	l33->AddEntry(H33,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	l33->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(2);
	H34->Draw();
	...
	l34->AddEntry(H34,"#splitline{phibarrel, minpt,}{ maxeta, zbarrel, z0}");
	l34->Draw();
	//S->Print(out_file_, "pdf");
        S->cd(3);
	H35->Draw();
	...
	l35->AddEntry(H35,"#splitline{minpt, maxeta}{ z0}");
	l35->Draw();
	//S->Print(out_file_, "pdf");
        /*S->cd(4);
	H41->Draw();
	...
	leg1->AddEntry(H2,"+ phi barrel cut = 0.02","lp");
	leg1->Draw();
	S->Print(out_file_open, "pdf");
	H1->Draw();
	H4->Draw("same");
	...
	leg5->SetTextSize(0.035);
        leg5->AddEntry(H11,"#splitline{phi barrel cut = 0.02 +}{Z0_{max} = 150}","lp");
        leg5->Draw();
        S->Print(out_file_, "pdf");
	H12->Draw();
        H14->Draw("same");
        H13->Draw("same");
	TLegend *leg6=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	H15->Draw();
        H17->Draw("same");
        H16->Draw("same");
	TLegend *leg7=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	H18->Draw();
        H20->Draw("same");
        H19->Draw("same");
	TLegend *leg8=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	H21->Draw();
        H23->Draw("same");
        H22->Draw("same");
	TLegend *leg9=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	dphi2_m->Draw("same");
	dphi2_t->Draw("same");
	*/TLegend *leg10=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	*/
	...
	H30->Draw();
        H32->Draw("same");
        H31->Draw("same");
	TLegend *leg12=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	H33->Draw();
        H35->Draw("same");
        H34->Draw("same");
	TLegend *leg13=new TLegend(x1,y1,x2,y2,"#splitline{phi Barrel = 0.02 +}{Zbarrel = 160 + Z0_{max} = 150}");
	...
	leg15->SetBorderSize(0);
        ...
        leg15->AddEntry(H_pur_vs_eta,"very wide cuts","lp");
        leg15->AddEntry(H_pur_vs_eta_,"wide cuts","lp");
        ...
        leg15->Draw();
        S->Print(out_file_, "pdf");
	H_pur_vs_eta_->GetYaxis()->SetRangeUser(0.6,1.05);
	H_pur_vs_eta_->Draw();
	H_pur_vs_eta_l->Draw("same");
	H_pur_vs_eta_m->Draw("same");
	H_pur_vs_eta_t->Draw("same");
	...
	leg16->SetBorderSize(0);
        ...
        leg16->AddEntry(H_pur_vs_eta_,"wide cuts","lp");
	...
	TLegend *leg17=new TLegend(x1,0.1,x2,0.33,"");
        ...
        leg17->AddEntry(H_pur_vs_pt,"very wide cuts","lp");
        leg17->AddEntry(H_pur_vs_pt_,"wide cuts","lp");
	...
	TLegend *leg18=new TLegend(x1,0.75,x2,y2,"");
        ...
        leg18->AddEntry(H_pur_vs_pt_,"wide cuts","lp");
