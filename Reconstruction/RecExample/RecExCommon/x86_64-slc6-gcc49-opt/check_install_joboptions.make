...
#cmt_local_tagfile_check_install_joboptions = $(RecExCommon_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(RecExCommon_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)RecExCommon_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)RecExCommonsetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share *.py  ' -installdir=/nfs/dust/atlas/user/tkar/derivations/InstallArea/jobOptions/RecExCommon -level=
