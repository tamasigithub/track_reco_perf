...
#cmt_local_tagfile_check_install_python_modules = $(RecExCommon_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(RecExCommon_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)RecExCommon_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)RecExCommonsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/nfs/dust/atlas/user/tkar/derivations/InstallArea/python/RecExCommon -level=
