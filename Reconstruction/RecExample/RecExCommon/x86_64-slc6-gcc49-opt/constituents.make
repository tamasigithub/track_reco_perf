...
#cmt_local_tagfile = $(RecExCommon_tag).make
cmt_local_tagfile = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_install_python_modules = $(bin)$(RecExCommon_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(RecExCommon_tag).make
...
cmt_RecExCommonTesting_test_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_RecExCommonTesting_test_has_target_tag

cmt_local_tagfile_RecExCommonTesting_test = $(bin)$(RecExCommon_tag)_RecExCommonTesting_test.make
cmt_final_setup_RecExCommonTesting_test = $(bin)setup_RecExCommonTesting_test.make
cmt_local_RecExCommonTesting_test_makefile = $(bin)RecExCommonTesting_test.make

RecExCommonTesting_test_extratags = -tag_add=target_RecExCommonTesting_test

else

cmt_local_tagfile_RecExCommonTesting_test = $(bin)$(RecExCommon_tag).make
cmt_final_setup_RecExCommonTesting_test = $(bin)setup.make
cmt_local_RecExCommonTesting_test_makefile = $(bin)RecExCommonTesting_test.make

endif

not_RecExCommonTesting_test_dependencies = { n=0; for p in $?; do m=0; for d in $(RecExCommonTesting_test_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
RecExCommonTesting_testdirs :
	@if test ! -d $(bin)RecExCommonTesting_test; then $(mkdir) -p $(bin)RecExCommonTesting_test; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)RecExCommonTesting_test
else
RecExCommonTesting_testdirs : ;
endif
...
ifndef QUICK
$(cmt_local_RecExCommonTesting_test_makefile) : $(RecExCommonTesting_test_dependencies) build_library_links
	$(echo) "(constituents.make) Building RecExCommonTesting_test.make"; \
	  $(cmtexe) -tag=$(tags) $(RecExCommonTesting_test_extratags) build constituent_config -out=$(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test
else
$(cmt_local_RecExCommonTesting_test_makefile) : $(RecExCommonTesting_test_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RecExCommonTesting_test) ] || \
	  [ ! -f $(cmt_final_setup_RecExCommonTesting_test) ] || \
	  $(not_RecExCommonTesting_test_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building RecExCommonTesting_test.make"; \
	  $(cmtexe) -tag=$(tags) $(RecExCommonTesting_test_extratags) build constituent_config -out=$(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test; \
	  fi
endif
...
$(cmt_local_RecExCommonTesting_test_makefile) : $(RecExCommonTesting_test_dependencies) build_library_links
	$(echo) "(constituents.make) Building RecExCommonTesting_test.make"; \
	  $(cmtexe) -f=$(bin)RecExCommonTesting_test.in -tag=$(tags) $(RecExCommonTesting_test_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test
else
$(cmt_local_RecExCommonTesting_test_makefile) : $(RecExCommonTesting_test_dependencies) $(cmt_build_library_linksstamp) $(bin)RecExCommonTesting_test.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RecExCommonTesting_test) ] || \
	  [ ! -f $(cmt_final_setup_RecExCommonTesting_test) ] || \
	  $(not_RecExCommonTesting_test_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(RecExCommonTesting_test_extratags) build constituent_makefile -out=$(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test

RecExCommonTesting_test :: $(RecExCommonTesting_test_dependencies) $(cmt_local_RecExCommonTesting_test_makefile) dirs RecExCommonTesting_testdirs
	$(echo) "(constituents.make) Starting RecExCommonTesting_test"
	@if test -f $(cmt_local_RecExCommonTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test; \
	  fi
#	@$(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_test
	$(echo) "(constituents.make) RecExCommonTesting_test done"

clean :: RecExCommonTesting_testclean ;

RecExCommonTesting_testclean :: $(RecExCommonTesting_testclean_dependencies) ##$(cmt_local_RecExCommonTesting_test_makefile)
	$(echo) "(constituents.make) Starting RecExCommonTesting_testclean"
	@-if test -f $(cmt_local_RecExCommonTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_testclean; \
	fi
	$(echo) "(constituents.make) RecExCommonTesting_testclean done"
#	@-$(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) RecExCommonTesting_testclean

##	  /bin/rm -f $(cmt_local_RecExCommonTesting_test_makefile) $(bin)RecExCommonTesting_test_dependencies.make

install :: RecExCommonTesting_testinstall ;

RecExCommonTesting_testinstall :: $(RecExCommonTesting_test_dependencies) $(cmt_local_RecExCommonTesting_test_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_RecExCommonTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : RecExCommonTesting_testuninstall

$(foreach d,$(RecExCommonTesting_test_dependencies),$(eval $(d)uninstall_dependencies += RecExCommonTesting_testuninstall))

RecExCommonTesting_testuninstall : $(RecExCommonTesting_testuninstall_dependencies) ##$(cmt_local_RecExCommonTesting_test_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_RecExCommonTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_RecExCommonTesting_test_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: RecExCommonTesting_testuninstall ;
...
cmt_RecExCommonrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_RecExCommonrchk_has_target_tag

cmt_local_tagfile_RecExCommonrchk = $(bin)$(RecExCommon_tag)_RecExCommonrchk.make
cmt_final_setup_RecExCommonrchk = $(bin)setup_RecExCommonrchk.make
cmt_local_RecExCommonrchk_makefile = $(bin)RecExCommonrchk.make

RecExCommonrchk_extratags = -tag_add=target_RecExCommonrchk

else

cmt_local_tagfile_RecExCommonrchk = $(bin)$(RecExCommon_tag).make
cmt_final_setup_RecExCommonrchk = $(bin)setup.make
cmt_local_RecExCommonrchk_makefile = $(bin)RecExCommonrchk.make

endif

not_RecExCommonrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(RecExCommonrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
RecExCommonrchkdirs :
	@if test ! -d $(bin)RecExCommonrchk; then $(mkdir) -p $(bin)RecExCommonrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)RecExCommonrchk
else
RecExCommonrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_RecExCommonrchk_makefile) : $(RecExCommonrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building RecExCommonrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(RecExCommonrchk_extratags) build constituent_config -out=$(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk
else
$(cmt_local_RecExCommonrchk_makefile) : $(RecExCommonrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RecExCommonrchk) ] || \
	  [ ! -f $(cmt_final_setup_RecExCommonrchk) ] || \
	  $(not_RecExCommonrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building RecExCommonrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(RecExCommonrchk_extratags) build constituent_config -out=$(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk; \
	  fi
endif
...
$(cmt_local_RecExCommonrchk_makefile) : $(RecExCommonrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building RecExCommonrchk.make"; \
	  $(cmtexe) -f=$(bin)RecExCommonrchk.in -tag=$(tags) $(RecExCommonrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk
else
$(cmt_local_RecExCommonrchk_makefile) : $(RecExCommonrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)RecExCommonrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RecExCommonrchk) ] || \
	  [ ! -f $(cmt_final_setup_RecExCommonrchk) ] || \
	  $(not_RecExCommonrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(RecExCommonrchk_extratags) build constituent_makefile -out=$(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk

RecExCommonrchk :: $(RecExCommonrchk_dependencies) $(cmt_local_RecExCommonrchk_makefile) dirs RecExCommonrchkdirs
	$(echo) "(constituents.make) Starting RecExCommonrchk"
	@if test -f $(cmt_local_RecExCommonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) RecExCommonrchk
	$(echo) "(constituents.make) RecExCommonrchk done"

clean :: RecExCommonrchkclean ;

RecExCommonrchkclean :: $(RecExCommonrchkclean_dependencies) ##$(cmt_local_RecExCommonrchk_makefile)
	$(echo) "(constituents.make) Starting RecExCommonrchkclean"
	@-if test -f $(cmt_local_RecExCommonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) RecExCommonrchkclean; \
	fi
	$(echo) "(constituents.make) RecExCommonrchkclean done"
#	@-$(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) RecExCommonrchkclean

##	  /bin/rm -f $(cmt_local_RecExCommonrchk_makefile) $(bin)RecExCommonrchk_dependencies.make

install :: RecExCommonrchkinstall ;

RecExCommonrchkinstall :: $(RecExCommonrchk_dependencies) $(cmt_local_RecExCommonrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_RecExCommonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : RecExCommonrchkuninstall

$(foreach d,$(RecExCommonrchk_dependencies),$(eval $(d)uninstall_dependencies += RecExCommonrchkuninstall))

RecExCommonrchkuninstall : $(RecExCommonrchkuninstall_dependencies) ##$(cmt_local_RecExCommonrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_RecExCommonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_RecExCommonrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: RecExCommonrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(RecExCommon_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(RecExCommon_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_myctest = $(bin)$(RecExCommon_tag)_myctest.make
...
cmt_local_tagfile_myctest = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_make = $(bin)$(RecExCommon_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(RecExCommon_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(RecExCommon_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(RecExCommon_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(RecExCommon_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(RecExCommon_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(RecExCommon_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(RecExCommon_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(RecExCommon_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(RecExCommon_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(RecExCommon_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(RecExCommon_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(RecExCommon_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(RecExCommon_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(RecExCommon_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(RecExCommon_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(RecExCommon_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_compile = $(bin)$(RecExCommon_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(RecExCommon_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(RecExCommon_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(RecExCommon_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(RecExCommon_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(RecExCommon_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(RecExCommon_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(RecExCommon_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(RecExCommon_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(RecExCommon_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(RecExCommon_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(RecExCommon_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(RecExCommon_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(RecExCommon_tag).make
