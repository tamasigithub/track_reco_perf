...
Float_t Xl1 = 0.16, Yu1 = 0.8, Xl2 = 0.36, Yu2 = 0.89;
Float_t Xr1 = 0.43, Ym1 = 0.5, Xr2 = 0.899, Ym2 = 0.76;
...
void Legends()
{
	leg1 = new TLegend(Xr1, Yu1+0.11, Xr2, Yu2+0.15);
	//leg1->AddEntry((TObject*)0, "#sqrt{s} = 100 TeV, B = 4T", "");
	leg1->AddEntry((TObject*)0, "#sqrt{s} = 100 TeV, B = 4T~~~~~ HH #rightarrow b#bar{b}b#bar{b}, pp #rightarrow b#bar{b}b#bar{b}", "");
	leg1->SetFillStyle(FILL_STYLE);
	leg1->SetBorderSize(BORDER_SIZE);
	leg1->SetTextSize(TEXT_SIZE);
	//leg1->SetTextAlign(kHAlignLeft+kVAlignBottom);
	leg1->SetTextAlign(kHAlignRight+kVAlignBottom);

	//leg2 = new TLegend(Xl2, Yu1-0.05, Xr2, Yu1-0.002);
	leg2 = new TLegend(Xr1+0.1, Yu1+0.05, Xr2, Yu1+0.09);
	leg2->AddEntry((TObject*)0, "p_{T} > 2GeV, |z_{vtx}| < 10cm", "");
	//leg2->AddEntry((TObject*)0, "final selection cuts", "");
	//leg2->AddEntry((TObject*)0, "p_{T} > 2GeV, |#eta| < 1.7, |z_{vtx}| < 10cm", "");
	...
	//leg5 = new TLegend(0.15, Yu1+0.03, Xl1, Yu2);
	leg5 = new TLegend(Xr1+0.1, Yu2+0.01, Xr2, Yu2+0.05);
