...
void Legends()
{
	leg1 = new TLegend(Xr1, Yu1+0.06, Xr2, Yu2);
	//leg1->AddEntry((TObject*)0, "#sqrt{s} = 100 TeV, B = 4T", "");
	leg1->AddEntry((TObject*)0, "#sqrt{s} = 100 TeV, B = 4T, HH #rightarrow b#bar{b}b#bar{b}, <#mu> = 1k", "");
	...
	leg2 = new TLegend(Xr1+0.1, Yu2+0.02, Xr2, Yu2+0.06);
