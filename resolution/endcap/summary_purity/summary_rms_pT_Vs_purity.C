...
//=========  (Mon Jul 19 15:12:01 2021) by ROOT version 6.18/00
   TCanvas *c1 = new TCanvas("c1", "c1",49,65,800,800);
   c1->Range(0.7662338,-0.3125,1.025974,2.8125);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.8,1);
   Graph_Graph01001->SetMinimum(0);
   Graph_Graph01001->SetMaximum(2.5);
   ...
   TH1F *Graph_Graph11002 = new TH1F("Graph_Graph11002","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.8,1);
   Graph_Graph11002->SetMinimum(0);
   Graph_Graph11002->SetMaximum(2.5);
   ...
   TH1F *Graph_Graph21003 = new TH1F("Graph_Graph21003","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.8,1);
   Graph_Graph21003->SetMinimum(0);
   Graph_Graph21003->SetMaximum(2.5);
   ...
   marker->Draw();
   marker = new TMarker(0.986945,2.12445,22);
   marker->SetMarkerStyle(22);
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.991405,2.12445,21);
   ...
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.979701,1.83345,22);
   marker->SetMarkerColor(2);
   marker->SetMarkerStyle(22);
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.990518,1.83345,21);
   marker->SetMarkerColor(2);
   marker->SetMarkerStyle(21);
   marker->SetMarkerSize(2);
   marker->Draw();
   ...
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.977588,1.65654,22);
   marker->SetMarkerColor(3);
   marker->SetMarkerStyle(22);
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.989731,1.65654,21);
   marker->SetMarkerColor(3);
   marker->SetMarkerStyle(21);
   marker->SetMarkerSize(2);
   marker->Draw();
   ...
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.97742,1.53964,22);
   marker->SetMarkerColor(4);
   marker->SetMarkerStyle(22);
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.990939,1.53964,21);
   marker->SetMarkerColor(4);
   marker->SetMarkerStyle(21);
   marker->SetMarkerSize(2);
   marker->Draw();
   ...
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.96973,1.46911,22);
   marker->SetMarkerColor(5);
   marker->SetMarkerStyle(22);
   marker->SetMarkerSize(2);
   marker->Draw();
   marker = new TMarker(0.991117,1.46911,21);
   marker->SetMarkerColor(5);
   marker->SetMarkerStyle(21);
   marker->SetMarkerSize(2);
   marker->Draw();
   ...
   TPaveText *pt = new TPaveText(0.15,0.9159302,0.85,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
