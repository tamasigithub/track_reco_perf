...
//=========  (Sun Feb 19 17:41:54 2023) by ROOT version 6.22/06
   TCanvas *c1 = new TCanvas("c1", "c1",49,90,800,800);
   c1->Range(0.8012987,0.73125,1.022078,1.91875);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","z_{0} resolution Vs track purity for various gap sizes of the TTT",100,0.83,1);
   Graph_Graph01001->SetMinimum(0.85);
   Graph_Graph01001->SetMaximum(1.8);
   ...
   Graph_Graph01001->GetXaxis()->SetTitle("purity, p_{T} #in (10, 100) GeV/c");
   Graph_Graph01001->GetXaxis()->CenterTitle(true);
   Graph_Graph01001->GetXaxis()->SetLabelFont(42);
   Graph_Graph01001->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph01001->GetXaxis()->SetTitleOffset(1.2);
   Graph_Graph01001->GetXaxis()->SetTitleFont(42);
   Graph_Graph01001->GetYaxis()->SetTitle("#sigma_{#delta z }[mm], at p_{T} #sim 10 GeV/c");
