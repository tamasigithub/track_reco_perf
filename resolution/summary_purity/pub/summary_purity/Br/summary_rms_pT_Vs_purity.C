...
//=========  (Sun Feb 19 16:53:41 2023) by ROOT version 6.22/06
   TCanvas *c1 = new TCanvas("c1", "c1",249,210,800,800);
   c1->Range(0.812987,0.5375,1.020779,1.1625);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   Graph_Graph01001->SetMaximum(1.1);
