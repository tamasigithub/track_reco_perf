...
//=========  (Wed Jan 29 17:35:16 2020) by ROOT version 6.12/06
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.84,1);
   ...
   Graph_Graph1001->GetYaxis()->SetTitle("#sigma_{#delta p_{T}/p_{T, gen}} [%], at p_{T} = 10 GeV/c");
   ...
   TH1F *Graph_Graph1002 = new TH1F("Graph_Graph1002","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.84,1);
   Graph_Graph1002->SetMinimum(0);
   Graph_Graph1002->SetMaximum(1.3);
   ...
   Graph_Graph1002->GetYaxis()->SetTitle("#sigma_{#delta p_{T}/p_{T, gen}} [%], at p_{T} = 10 GeV/c");
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","Relative p_{T} resolution Vs track purity for various gap sizes of the TTT",100,0.84,1);
   ...
   Graph_Graph1003->GetYaxis()->SetTitle("#sigma_{#delta p_{T}/p_{T, gen}} [%], at p_{T} = 10 GeV/c");
