...
//        h0_dca->GetXaxis()->SetTitleSize(.05);	
	...
	h0_dp->GetYaxis()->SetTitle("#sigma_{#Delta(p_{t})/gen_p_{t}}");
        h0_invpt->GetYaxis()->SetTitle("#sigma_{#Delta(1/p_{t})} [GeV/c]^{-1}");
        h0_phi->GetYaxis()->SetTitle("#sigma_{#Delta(#phi)} [rad]");
        h0_theta->GetYaxis()->SetTitle("#sigma_{#Delta(#theta)} [rad]");
        h0_eta->GetYaxis()->SetTitle("#sigma_{#Delta(#eta)}");
        h0_z0->GetYaxis()->SetTitle("#sigma_{#Delta(z0)} [mm]");
